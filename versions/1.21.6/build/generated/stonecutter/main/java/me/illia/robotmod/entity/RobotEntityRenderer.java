...
public class RobotEntityRenderer extends MobEntityRenderer<RobotEntity, RobotEntityRenderState, RobotEntityModel> {
	...
	public void updateRenderState(RobotEntity livingEntity, RobotEntityRenderState livingEntityRenderState, float f) {
		...
		//? if >1.21.3 {
		itemModelManager.updateForLivingEntity(livingEntityRenderState.rightHandItemState, entity == null ? livingEntity.inv.getStack(livingEntity.slot) : entity.inv.getStack(entity.slot), ItemDisplayContext.FIXED, livingEntity);
		//?} else {
