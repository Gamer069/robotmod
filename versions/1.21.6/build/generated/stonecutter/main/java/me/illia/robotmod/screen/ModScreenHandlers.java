...
public class ModScreenHandlers {
	public static ExtendedScreenHandlerType<ChooseTeleportScreenHandler, TeleportPointAttachedData> CHOOSE_TELEPORT_SCREEN_HANDLER = Util.<ChooseTeleportScreenHandler, TeleportPointAttachedData>extendedScreenHandler(Util.id("choose_teleport_sh"), ChooseTeleportScreenHandler::new, PacketCodecs.codec(TeleportPointAttachedData.CODEC));
